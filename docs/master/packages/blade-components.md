...
| **`track_by`** | `String`  | `'code'`  | Field to use as option value                                 |
| **`label_by`** | `String`  | `'label'`| Field to display in the select                              |
| **`list_route`**| `String` | `null`  | Route for fetching options                                    |
