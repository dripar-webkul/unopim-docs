...
export default {
  ...
  methods: {
    changeText() {
      ...
      }else if (['0.3'].includes(version)) {
        this.displayText = `This is the documentation for the current version (v0.3) of UnoPim. Stay informed and make the most of UnoPim's capabilities.`;
